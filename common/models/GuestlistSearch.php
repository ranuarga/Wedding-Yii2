...
/**
 * GuestlistSearch represents the model behind the search form of `common\models\Guestlist`.
 */
class GuestlistSearch extends Guestlist
{
    ...
    {
        return [
            [['id_guest', 'amount'], 'integer'],
            [['id_user', 'guest_name', 'invitation', 'status'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'guest_name', $this->guest_name])
            ->andFilterWhere(['like', 'invitation', $this->invitation])
